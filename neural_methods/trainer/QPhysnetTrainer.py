...
from neural_methods.model.QPhysNet import QuaternionPhysNet_padding_Encoder_Decoder_MAX
from neural_methods.trainer.BaseTrainer import BaseTrainer
from torch.autograd import Variable
from tqdm import tqdm


class QPhysnetTrainer(BaseTrainer):
    ...
    def __init__(self, config, data_loader):
        ...
        self.model = QuaternionPhysNet_padding_Encoder_Decoder_MAX(
