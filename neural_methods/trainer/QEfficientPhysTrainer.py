...
from neural_methods.model.QEfficientPhys import QuaternionEfficientPhys
from neural_methods.trainer.BaseTrainer import BaseTrainer
from tqdm import tqdm


class QEfficientPhysTrainer(BaseTrainer):
    ...
    def __init__(self, config, data_loader):
        ...
        if config.TOOLBOX_MODE == "train_and_test":
            self.model = QuaternionEfficientPhys(frame_depth=self.frame_depth, img_size=config.TRAIN.DATA.PREPROCESS.RESIZE.H).to(
                self.device)
